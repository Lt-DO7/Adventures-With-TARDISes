...
public class AWTDevTeam {
    ...
    public static final UUID LIGHT = UUID.fromString("7be04a37-5142-45ea-a741-c02fa2f4f633");
    ...
    public static final List<UUID> UUIDList = List.of(LEFT,DINO,DEO,ENCDATA,SCARFO,LIGHT,BLUEBERRY,RHAMMII);
