...
public class classic_policebox extends SimpleExteriorModel {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		.uv(156, 51).cuboid(7.875F, -37.875F, -9.375F, 2.25F, 36.75F, 1.5F, new Dilation(0.0F))
		.uv(156, 90).cuboid(-10.125F, -37.875F, -9.375F, 2.25F, 36.75F, 1.5F, new Dilation(0.0F))
		.uv(140, 145).cuboid(-10.125F, -2.25F, -7.875F, 0.75F, 0.75F, 15.75F, new Dilation(0.0F))
		.uv(34, 158).cuboid(-10.125F, -37.875F, 7.875F, 2.25F, 36.75F, 1.5F, new Dilation(0.0F))
		.uv(42, 158).cuboid(7.875F, -37.875F, 7.875F, 2.25F, 36.75F, 1.5F, new Dilation(0.0F))
		...
		.uv(156, 0).cuboid(-8.625F, -36.75F, 9.0F, 17.25F, 2.25F, 0.75F, new Dilation(0.0F))
		.uv(108, 126).cuboid(9.375F, -36.75F, -8.25F, 1.5F, 2.25F, 16.5F, new Dilation(0.0F))
		.uv(146, 133).cuboid(-8.625F, -36.75F, 8.625F, 17.25F, 2.25F, 1.5F, new Dilation(0.0F))
		.uv(136, 32).cuboid(9.75F, -36.75F, -8.25F, 0.75F, 2.25F, 16.5F, new Dilation(0.0F))
		.uv(70, 126).cuboid(-10.875F, -36.75F, -8.25F, 1.5F, 2.25F, 16.5F, new Dilation(0.0F))
		.uv(0, 125).cuboid(-10.5F, -36.75F, -8.25F, 0.75F, 2.25F, 16.5F, new Dilation(0.0F))
		.uv(146, 140).cuboid(-7.875F, -34.5F, -8.625F, 15.75F, 1.5F, 2.0F, new Dilation(0.0F))
		.uv(36, 140).cuboid(-10.125F, -34.5F, -7.875F, 0.75F, 1.5F, 15.75F, new Dilation(0.0F))
		.uv(156, 3).cuboid(-7.875F, -34.5F, 7.875F, 15.75F, 1.5F, 0.75F, new Dilation(0.0F))
		.uv(0, 144).cuboid(9.375F, -34.5F, -7.875F, 0.75F, 1.5F, 15.75F, new Dilation(0.0F))
		.uv(66, 61).cuboid(-9.375F, -33.0F, -7.875F, 1.5F, 31.5F, 15.75F, new Dilation(0.0F))
		.uv(122, 0).cuboid(-7.875F, -33.0F, 7.125F, 15.75F, 31.5F, 0.75F, new Dilation(0.0F))
		.uv(0, 78).cuboid(7.875F, -33.0F, -7.875F, 1.5F, 31.5F, 15.75F, new Dilation(0.0F))
		.uv(102, 47).cuboid(8.25F, -33.0F, -7.875F, 0.75F, 31.5F, 15.75F, new Dilation(0.0F))
		.uv(88, 0).cuboid(-9.0F, -33.0F, -7.875F, 0.75F, 31.5F, 15.75F, new Dilation(0.0F))
		.uv(76, 23).cuboid(-10.125F, -33.0F, -0.375F, 0.75F, 30.75F, 0.75F, new Dilation(0.0F))
		.uv(74, 23).cuboid(-0.625F, -33.0F, 7.875F, 1.0F, 31.5F, 0.375F, new Dilation(0.0F))
		.uv(36, 78).cuboid(9.375F, -33.0F, -0.375F, 0.75F, 29.25F, 0.75F, new Dilation(0.0F))
		.uv(36, 108).cuboid(-7.875F, -33.0F, 6.75F, 15.75F, 31.5F, 0.75F, new Dilation(0.0F))
		.uv(0, 42).cuboid(-9.75F, -37.875F, -8.625F, 19.5F, 1.5F, 17.25F, new Dilation(0.0F))
		.uv(0, 61).cuboid(-8.625F, -33.75F, -7.875F, 17.25F, 0.75F, 15.75F, new Dilation(0.0F))
		.uv(106, 145).cuboid(9.375F, -2.25F, -7.875F, 0.75F, 0.75F, 15.75F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
		...
		ModelPartData roof = frame.addChild("roof", ModelPartBuilder.create().uv(0, 23).cuboid(-9.375F, -0.75F, -9.0F, 18.75F, 1.0F, 18.0F, new Dilation(0.0F))
		.uv(74, 55).cuboid(-2.625F, -1.5F, -2.625F, 5.25F, 0.75F, 5.25F, new Dilation(0.0F))
		.uv(95, 48).cuboid(-1.5F, -6.75F, -1.5F, 3.0F, 5.25F, 3.0F, new Dilation(0.0F))
		...
		ModelPartData ls_1 = roof.addChild("ls_1", ModelPartBuilder.create().uv(40, 84).cuboid(-3.375F, -3.75F, 0.0F, 6.75F, 3.75F, 0.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -1.5F, 0.0F, 0.0F, -0.7854F, 0.0F));

		ModelPartData ls_2 = roof.addChild("ls_2", ModelPartBuilder.create().uv(40, 88).cuboid(-3.375F, -3.75F, 0.0F, 6.75F, 3.75F, 0.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -1.5F, 0.0F, 0.0F, 0.7854F, 0.0F));
		...
		ModelPartData portal = parent.addChild("portal", ModelPartBuilder.create().uv(102, 94).cuboid(-8.0583F, -33.0F, 0.0F, 17.0F, 31.5F, 0.75F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 0.0F, 0.5F));
