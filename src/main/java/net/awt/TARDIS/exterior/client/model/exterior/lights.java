...
public class lights extends SimpleExteriorModel {
	private final ModelPart root;
	private final ModelPart door;
	private final ModelPart left_door;
	private final ModelPart right_door;
	private final ModelPart frame;
	public lights(ModelPart root) {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		.uv(51, 129).cuboid(-9.0517F, -2.5767F, -7.6583F, 2.0F, 3.0F, 15.0F, new Dilation(0.0F))
		...
		.uv(88, 185).cuboid(-8.25F, -33.02F, -8.25F, 16.5F, 1.5F, 16.5F, new Dilation(0.0F))
		...
		.uv(151, 68).cuboid(-0.4983F, -42.085F, -0.5683F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F))
		.uv(147, 66).cuboid(-1.4983F, -41.8183F, -1.5683F, 3.0F, 1.0F, 3.0F, new Dilation(0.0F))
		...
		ModelPartData frame_r2 = frame.addChild("frame_r2", ModelPartBuilder.create().uv(158, 111).cuboid(0.0259F, -1.875F, -2.5343F, 0.0F, 3.0F, 5.0F, new Dilation(0.0F)), ModelTransform.of(-0.0533F, -39.9433F, 0.0F, 0.0F, 2.3126F, 0.0F));

		ModelPartData frame_r3 = frame.addChild("frame_r3", ModelPartBuilder.create().uv(158, 111).cuboid(0.0259F, -1.875F, -2.5343F, 0.0F, 3.0F, 5.0F, new Dilation(0.0F)), ModelTransform.of(-0.0533F, -39.9433F, 0.0F, 0.0F, 0.7854F, 0.0F));
